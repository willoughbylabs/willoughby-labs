...
<div class="content-body-intro">
    <p>I'm not passionate about hot dogs, but sometimes I'm in the mood for them (especially when dragged through the
        garden, Chicago style). Similarly, sometimes I'm in the mood for writing. My favorite writing tool is Notion.
...
<div class="content-body-intro">
    <p>Thanks to the World Wide Web, these bits of life can now collect dust(strikethrough) in a
        virtual attic. I'm going to need a bigger boat(strikethrough) database to make this work efficiently so please
...
<div class="content-body-main">
    <p>Raised in an Air Force family, Chicago is my 10th place to call home. I like to learn and ponder so my interests
        expand like the universe. From web dev, architecture, politics, and astronomy to video games, photography,
        vinyl, and cycling, I'm only bored when I want to be. I'm a fledgling developer, and my intended projects are
        inspired by simplifying raw data; I feel "seeing the numbers" in a digestible format helps generate fact-based
        opinions. Insert "the
        more you know" GIF. </p>
    <p>"At dawn, when you have trouble getting out of bed, tell yourself: ‘I have to go to work—as a human being. What
        do I have to complain of, if I’m going to do what I was born for—the things I was brought into the world to do?
